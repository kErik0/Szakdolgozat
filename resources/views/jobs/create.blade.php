                ...
                <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-6 w-full max-w-xl">
                    ...
                    <form action="{{ route('jobs.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <x-primary-button class="bg-gray-900 hover:bg-gray-700" onclick="window.location='{{ route('jobs.index') }}'" type="button">
                                Mégse
                            </x-primary-button>
                        </div>
                    </form>
